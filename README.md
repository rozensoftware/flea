...
- **history** : Reads web browsers history of a user which flea process is running for: Edge (Windows only) and Google Chrome. Data returned are: URL, Title and Visits Number.
